...
open class SendValidateOtpAuthenticatorFactory : AbstractAuthenticatorFactory() {
    override fun create(session: KeycloakSession, apiGateway: ApiGateway) = SendValidateOtpAuthenticator()
    ...
    override fun getHelpText() =
        "Sends an OTP challenge to the collected phone and validates the submitted code."
