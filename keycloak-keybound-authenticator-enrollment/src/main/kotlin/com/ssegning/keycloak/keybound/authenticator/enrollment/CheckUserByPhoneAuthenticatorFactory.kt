...
open class CheckUserByPhoneAuthenticatorFactory : AbstractAuthenticatorFactory() {
    override fun create(session: KeycloakSession, apiGateway: ApiGateway) = CheckUserByPhoneAuthenticator()
    ...
    override fun getHelpText() =
        "Finds an existing user by the collected E.164 phone without creating a new user."
