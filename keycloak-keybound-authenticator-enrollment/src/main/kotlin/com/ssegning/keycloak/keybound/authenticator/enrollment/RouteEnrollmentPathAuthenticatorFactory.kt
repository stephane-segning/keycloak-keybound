...
open class RouteEnrollmentPathAuthenticatorFactory : AbstractAuthenticatorFactory() {
    override fun create(session: KeycloakSession, apiGateway: ApiGateway) = RouteEnrollmentPathAuthenticator()
    ...
    override fun getHelpText() =
        "Selects approval path when a resolved user already has device credentials, otherwise selects OTP path."
