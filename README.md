...
| Module                                       | Role                                                                                                    |
|----------------------------------------------|---------------------------------------------------------------------------------------------------------|
| `keycloak-keybound-authenticator-enrollment` | Captures and binds a user/device pair, emits device key credential.                                     |
| `keycloak-keybound-authenticator-approval`   | Verifies the device challenge response (signature, nonce, timestamp) before issuing tokens.             |
